...
#==========start================================================================
import os, sys, shlex 
print('qucs-netlist.py, qucs-netlist.dat and the schematic to convert, must all be in your current directory.')
netlist = []
...
print ('--------------------------------------------------------------------------------')
print ('Start Qucs utility to make "sim" file, it will list many unimportant missing font errors.')
print ()
